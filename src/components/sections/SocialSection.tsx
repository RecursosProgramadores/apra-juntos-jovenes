            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                {eventos.length > 0 ? (
                  ...
                  <div className="p-12 text-center rounded-xl bg-background/5 border border-dashed border-background/20">
                    <p className="text-background/50 italic">Aún no hay eventos registrados</p>
                  </div>
                )}
              </div>
            )}
