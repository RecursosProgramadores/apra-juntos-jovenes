  ...
  if (links.length === 0) {
    ...
    return (
      <div className="flex flex-wrap justify-center gap-4">
        <a href="https://twitter.com/ApraJheremy" target="_blank" rel="noopener noreferrer" 
        ...
        <a href="https://instagram.com/jheremy_apra" target="_blank" rel="noopener noreferrer"
        ...
        <a href="https://tiktok.com/@aprajheremy" target="_blank" rel="noopener noreferrer"
           className="flex items-center gap-2 px-6 py-3 bg-foreground text-background rounded-full font-bold hover:opacity-90 transition-opacity">
